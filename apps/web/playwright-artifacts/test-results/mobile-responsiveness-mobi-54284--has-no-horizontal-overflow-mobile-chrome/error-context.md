...
- Name: mobile-responsiveness.spec.ts >> mobile audit @ 320px >> /releases has no horizontal overflow
...
Call log:
  - navigating to "http://localhost:4321/releases", waiting until "networkidle"
